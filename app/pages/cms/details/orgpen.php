...
$org_id = isset($_GET['org_id']) ? intval($_GET['org_id']) : 3;
    ...
    <section class="main-content">
        ...
        <div class="content">
            <div class="content-header">
                ...
                <h2>PUP Electrical Engineering Network</h2>
            </div>

            <div class="org-details">
                <div class="logo-display">
                    <img src="/app/img/EEN.jpg" alt="Organization Logo" id="org-logo">
                </div>               

                <label for="orgName">Organization Name</label>
                <input type="text" name="orgName" id="orgName" placeholder="PUP Electrical Engineering Network" disabled>

                <label for="orgDeets">Description</label>
                <textarea name="orgDeets" id="orgDeets" placeholder="A student organization at PUP dedicated to uniting and empowering Electrical Engineering students through training and collaboration." disabled></textarea>

                <label for="orgEmail">Organization Email</label>
                <input type="email" name="orgEmail" id="orgEmail" placeholder="pen@pup.edu.ph" disabled>

                <label for="orgDate">Established Date</label>
                <input type="text" name="orgDate" id="orgDate" placeholder="2016-07-21" disabled>
            </div>
