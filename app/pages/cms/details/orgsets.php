...
$org_id = isset($_GET['org_id']) ? intval($_GET['org_id']) : 2;
    ...
    <section class="main-content">
        ...
        <div class="content">
            <div class="content-header">
                ...
                <h2>Society of Engineering Technology Students</h2>
            </div>

            <div class="org-details">
                <div class="logo-display">
                    <img src="/app/img/SET.jpg" alt="Organization Logo" id="org-logo">
                </div>                  

                <label for="orgName">Organization Name</label>
                <input type="text" name="orgName" id="orgName" placeholder="Society of Engineering Technology Students" disabled>

                <label for="orgDeets">Description</label>
                <textarea name="orgDeets" id="orgDeets" placeholder="A student organization at PUP uniting and empowering students in the field of Engineering Technology." disabled></textarea>

                <label for="orgEmail">Organization Email</label>
                <input type="email" name="orgEmail" id="orgEmail" placeholder="sets@pup.edu.ph" disabled>

                <label for="orgDate">Established Date</label>
                <input type="text" name="orgDate" id="orgDate" placeholder="2014-01-30" disabled>
            </div>
