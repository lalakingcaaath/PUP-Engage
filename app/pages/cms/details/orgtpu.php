...
$org_id = isset($_GET['org_id']) ? intval($_GET['org_id']) : 1;
        ...
        <div class="content">
            ...
            <div class="org-details">
                <div class="logo-display">
                    <img src="https://60c5-136-158-24-254.ngrok-free.app/pup-engage/app/img/TPG.jpg" alt="Organization Logo" id="org-logo">
                </div>                
                ...
                <textarea name="orgDeets" id="orgDeets" placeholder="A dynamic, non-academic student organization at PUP dedicated to fostering a strong community of programmers, developers, and tech enthusiasts." disabled></textarea>

                <label for="orgEmail">Organization Email</label>
                <input type="email" name="orgEmail" id="orgEmail" placeholder="tpg@pup.edu.ph" disabled>

                <label for="orgDate">Established Date</label>
                <input type="text" name="orgDate" id="orgDate" placeholder="2013-04-28" disabled>
            </div>
