...
$org_id = isset($_GET['org_id']) ? intval($_GET['org_id']) : 4;
    ...
    <section class="main-content">
        ...
        <div class="content">
            <div class="content-header">
                ...
                <h2>Microsoft Student Community</h2>
            </div>
            ...
            <div class="org-details">
                ...
                <input type="text" name="orgName" id="orgName" placeholder="Microsoft Student Community" disabled>

                <label for="orgDeets">Description</label>
                <textarea name="orgDeets" id="orgDeets" placeholder="A student-led organization at PUP fostering a passion for technology, innovation, and professional growth." disabled></textarea>

                <label for="orgEmail">Organization Email</label>
                <input type="email" name="orgEmail" id="orgEmail" placeholder="msc@pup.edu.ph" disabled>

                <label for="orgDate">Established Date</label>
                <input type="text" name="orgDate" id="orgDate" placeholder="2018-09-15" disabled>
            </div>
