...
$org_id = isset($_GET['org_id']) ? intval($_GET['org_id']) : 6;
...
<head>
    ...
    <script src="https://60c5-136-158-24-254.ngrok-free.app/pup-engage/app/js/addMemberModal.js" defer></script>
    <script>
    ...
    <section class="main-content">
        ...
        <div class="content">
            <div class="content-header">
                ...
                <h2>Electrical Engineering - PUP Wired</h2>
            </div>

            <div class="org-details">
                <div class="logo-display">
                    <img src="https://60c5-136-158-24-254.ngrok-free.app/pup-engage/app/img/Wired.jpg" alt="Organization Logo" id="org-logo">
                </div>                 

                <label for="orgName">Organization Name</label>
                <input type="text" name="orgName" id="orgName" placeholder="Electrical Engineering - PUP Wired" disabled>

                <label for="orgDeets">Description</label>
                <textarea name="orgDeets" id="orgDeets" placeholder="A student organization at PUP Manila dedicated to enhancing engineering students' technical expertise through training and industry partnerships." disabled></textarea>

                <label for="orgEmail">Organization Email</label>
                <input type="email" name="orgEmail" id="orgEmail" placeholder="ee_wired@pup.edu.ph" disabled>

                <label for="orgDate">Established Date</label>
                <input type="text" name="orgDate" id="orgDate" placeholder="2015-06-10" disabled>
            </div>
                ...
                <?php if ($members_result->num_rows > 0): ?>
                    ...
                    <?php while ($member = $members_result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <form action="https://60c5-136-158-24-254.ngrok-free.app/pup-engage/app/pages/cms/details/remove_member.php" method="POST" onsubmit="return confirmRemove();">
            ...
            <div id="addMemberModal" class="modal">
                <div class="modal-content">
                    ...
                    <h2>Add Member</h2>
                    <form action="https://60c5-136-158-24-254.ngrok-free.app/pup-engage/app/pages/cms/details/add_member.php" method="POST">
                        <input type="hidden" name="organization_id" value="<?php echo $org_id; ?>">
