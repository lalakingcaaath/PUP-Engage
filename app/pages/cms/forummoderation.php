...
<section class="main-content">
    <div class="sidenav">
        <div class="profile">
            <img src="/app/img/adminlogo.png" alt="Admin Logo">
            <h2>Admin</h2>
        </div>
        <ul>
    ...
    <div class="content">
        <div class="content-header">
            <img src="/app/img/icons8-person-96.png" alt="Forum">
        ...
        <div class="card">
            <div class="card-item">
                <img src="/app/img/icons8-inbox-96.png" alt="Total Posts">
                <p><?php echo $totalPosts; ?></p>
                <p>Total Posts</p>
            </div>
            <div class="card-item">
                <img src="/app/img/icons8-message-96.png" alt="Total Comments">
                <p><?php echo $totalComments; ?></p>
                <p>Total Comments</p>
            </div>
            <div class="card-item">
                <img src="/app/img/icons8-proactivity-96.png" alt="Active Threads">
                <p>6</p> <!-- Static value -->
                <p>Active Threads</p>
            </div>
            <div class="card-item">
                <img src="/app/img/icons8-alert-96.png" alt="Reported Posts">
                <p>2</p> <!-- Static value -->
                <p>Reported Posts</p>
            </div>
        </div>
