...
<body>
    ...
    <section class="store">
        <div class="search-store">
            ...
            <a href="#"><button><img src="/app/img/icons8-shopping-bag-24.png" alt="shopping bag"></button></a>
        </div>
    </section>
    <section class="checkout">
        ...
        <div class="checkout-deets">
            ...
            <p>CEA Shirt <br><span>Variations: Small Maroon</span></p>
            <p>P150</p>
            <p>1</p>
            <p>P150</p>
        </div>
        <div class="checkout-final">
            ...
            <div class="payment-deets">
                <p>Merchandise Subtotal<span>P150</span></p>
                <p>Shipping Subtotal<span>P50</span></p>
                <p>Total Final<span>P200</span></p>
            </div>
